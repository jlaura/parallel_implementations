...
name = sys.argv[1]
mem_name = sys.argv[2]
samples = [125,250,500,1000,2000,4000,6000,8000,16000, 24000, 32000, 36000, 40000,50000,60000,75000]
classes = [ 5 , 7, 9]
...
for k in classes:
    ...
    plt.plot(fj_new_mp_multi_diam, samples, c='yellow', label='Diameter Matrix Computation')
    plt.plot(fj_new_mp_multi_err, samples, c='blue', label='Error Matrix Computation Time', linewidth=2.0, linestyle='--')
    ...
    plt.xlabel('RAM (MB)')
    plt.ylabel('# samples')
    plt.title('Total memory usage as measured by the resource module')
    plt.grid()
